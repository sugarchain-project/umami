...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--nosandbox --exclude feature_init,rpc_bind,feature_bind_extra"  # Excluded for now, see https://github.com/sugarchain/sugarchain/issues/17765#issuecomment-602068547
export GOAL="install"
