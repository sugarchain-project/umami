...
complete --command sugarchaind --no-files

# Extract options
function __fish_sugarchaind_get_options
...
complete \
    --command sugarchaind \
    --arguments "(__fish_sugarchaind_get_options --nofiles)"
