...
complete --command sugarchain-qt --no-files

# Extract options
function __fish_sugarchainqt_get_options
...
complete \
    --command sugarchain-qt \
    --arguments "(__fish_sugarchainqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c sugarchain-qt \
...
complete \
    --command sugarchain-qt \
    --arguments "(__fish_sugarchainqt_get_options --nofiles)"
