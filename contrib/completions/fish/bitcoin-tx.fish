...
# Extract options
function __fish_sugarchain_tx_get_options
...
# Extract commands
function __fish_sugarchain_tx_get_commands
...
# Add options
complete \
    --command sugarchain-tx \
    --condition "not __fish_sugarchain_seen_cmd (__fish_sugarchain_tx_get_commands --commandsonly)" \
    --arguments "(__fish_sugarchain_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command sugarchain-tx \
    --arguments "(__fish_sugarchain_tx_get_commands)" \
    --no-files
