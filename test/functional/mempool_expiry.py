...
class MempoolExpiryTest(SugarchainTestFramework):
    ...
    def test_transaction_expiry(self, timeout):
        ...
        assert_equal(
            parent_txid, node.getmempoolentry(child_txid)["depends"][0]
        )
        self.log.info(
            "Broadcast child transaction after {} hours.".format(
        ...
        self.log.info(
            "Test parent tx not expired after {} hours.".format(
        ...
        self.log.info(
            "Test parent tx expiry after {} hours.".format(
        ...
        assert_equal(
            half_expiry_time, node.getmempoolentry(independent_txid)["time"]
        )
    ...
    def run_test(self):
        ...
        self.log.info(
            "Test default mempool expiry timeout of %d hours."
            % DEFAULT_MEMPOOL_EXPIRY_HOURS
        )
        self.test_transaction_expiry(DEFAULT_MEMPOOL_EXPIRY_HOURS)

        self.log.info(
            "Test custom mempool expiry timeout of %d hours."
