...
class CoinStatsIndexTest(SugarchainTestFramework):
    ...
    def _test_coin_stats_index(self):
        ...
        # Find the right position of the 21 SUGAR output
        ...
        for hash_option in index_hash_options:
            ...
            assert_equal(
                res6["total_unspendable_amount"], Decimal("70.99000000")
            )
            assert_equal(
                res6["block_info"],
                {
        ...
        for hash_option in index_hash_options:
            ...
            assert_equal(
                res7["total_unspendable_amount"], Decimal("80.99000000")
            )
            assert_equal(
                res7["block_info"],
                {
    ...
    def _test_index_rejects_hash_serialized(self):
        ...
        msg = (
            "hash_serialized_2 hash type cannot be queried for a specific block"
        )
        assert_raises_rpc_error(
            -8,
            msg,
