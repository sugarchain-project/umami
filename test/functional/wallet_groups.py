...
class WalletGroupTest(SugarchainTestFramework):
    ...
    def set_test_params(self):
        ...
        for args in self.extra_args:
            ...
            args.append(
                f"-paytxfee={20 * 1e3 / 1e8}"
            )  # apply feerate of 20 sats/vB across all nodes
    ...
    def run_test(self):
        ...
        # Sending 1.4 sugar should pick one 1.0 + one more. For node #1,
        ...
        with self.nodes[3].assert_debug_log(
            ...
            txid5 = self.nodes[3].sendtoaddress(
                self.nodes[0].getnewaddress(), 2.95
            )
