...
"""
Test starting sugarchaind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(SugarchainTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that sugarchaind has bound on "::1" (for RPC) and "::" (for P2P).
            ipv6_addr_len_bytes = 32
            binds = set(
                filter(lambda e: len(e[0]) != ipv6_addr_len_bytes, binds)
            )
