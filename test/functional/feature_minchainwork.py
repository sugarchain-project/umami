...
class MinimumChainWorkTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        assert (
            self.nodes[1].getbestblockhash() != self.nodes[0].getbestblockhash()
        )
        ...
        assert_equal(
            self.nodes[2].getblockchaininfo()["initialblockdownload"], True
        )
