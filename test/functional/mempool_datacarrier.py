...
class DataCarrierTest(SugarchainTestFramework):
    ...
    def test_null_data_transaction(
        self, node: TestNode, data: bytes, success: bool
    ) -> None:
    ...
    def run_test(self):
        ...
        self.test_null_data_transaction(
            node=self.nodes[0], data=too_long_data, success=False
        )
        ...
        self.test_null_data_transaction(
            node=self.nodes[1], data=default_size_data, success=False
        )
        ...
        self.test_null_data_transaction(
            node=self.nodes[2], data=default_size_data, success=False
        )
