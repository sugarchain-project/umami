...
class KeypoolRestoreTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        for i, output_type in enumerate(["legacy", "p2sh-segwit", "bech32"]):
            ...
            if i == 0:
                assert (
                    not address_details["isscript"]
                    and not address_details["iswitness"]
                )
            elif i == 1:
                assert (
                    address_details["isscript"]
                    and not address_details["iswitness"]
                )
            else:
                assert (
                    not address_details["isscript"]
                    and address_details["iswitness"]
                )
            ...
            assert_equal(
                self.nodes[idx].listtransactions()[0]["category"], "receive"
            )
