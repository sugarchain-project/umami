...
class FilelockTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info(
            "Check that we can't start a second sugarchaind instance using the same datadir"
        )
        ...
        if self.is_wallet_compiled():
            ...
            def check_wallet_filelock(descriptors):
                ...
                self.log.info(
                    "Check that we can't start a second sugarchaind instance using the same wallet"
                )
                if descriptors:
