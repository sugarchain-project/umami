...
class DeriveaddressesTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        address = "bcrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr34acd5"
        assert_equal(
            self.nodes[0].deriveaddresses(descriptor_pubkey), [address]
        )
        ...
        assert_equal(
            self.nodes[0].deriveaddresses(combo_descriptor),
            [
        ...
        # Before #26275, sugarchaind would crash when deriveaddresses was
        # called with derivation index 2147483647, which is the maximum
        # positive value of a signed int32, and - currently - the
        # maximum value that the deriveaddresses sugarchain RPC call
        ...
        assert_equal(
            ...
            ["bcrt1qtzs23vgzpreks5gtygwxf8tv5rldxvvsyfpdkg"],
        )
