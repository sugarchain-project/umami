...
class WalletCrossChain(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        node0_wallet_backup = os.path.join(
            self.nodes[0].datadir, "node0_wallet.bak"
        )
        ...
        node1_wallet_backup = os.path.join(
            self.nodes[0].datadir, "node1_wallet.bak"
        )
