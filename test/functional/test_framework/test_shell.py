...
class TestShell:
    """Wrapper Class for SugarchainTestFramework.

    The TestShell class extends the SugarchainTestFramework
    ...
    class __TestShell(SugarchainTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SugarchainTestFramework child class.
            self.num_nodes = 1
