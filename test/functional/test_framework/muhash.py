...
class MuHash3072:
    ...
    See https://cseweb.ucsd.edu/~mihir/papers/inchash.pdf and https://lists.linuxfoundation.org/pipermail/sugarchain-dev/2017-May/014337.html
    """
    ...
    def insert(self, data):
        ...
        self.numerator = (
            self.numerator * data_to_num3072(data_hash)
        ) % self.MODULUS
    ...
    def digest(self):
        ...
        val = (
            self.numerator * modinv(self.denominator, self.MODULUS)
        ) % self.MODULUS
