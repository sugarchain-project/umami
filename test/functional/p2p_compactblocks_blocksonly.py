#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Sugarchain Core developers
...
class P2PCompactBlocksBlocksOnly(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(
            p2p_conn_blocksonly.last_message["sendcmpct"].announce, False
        )
        ...
        def test_for_cmpctblock(block):
            ...
            return (
                p2p_conn_blocksonly.last_message[
                    "cmpctblock"
                ].header_and_shortids.header.rehash()
                == block.sha256
            )
