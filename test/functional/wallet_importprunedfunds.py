...
class ImportPrunedFundsTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        mb.header.hashMerkleRoot = (
            0xDEADBEEF  # cause mismatch between merkle root and merkle block
        )
        assert_raises_rpc_error(
            -5,
        ...
        mb = from_hex(CMerkleBlock(), proof1)
        mb.header.nTime += (
            1  # modify arbitrary block header field to change block hash
        )
        assert_raises_rpc_error(
            -5,
