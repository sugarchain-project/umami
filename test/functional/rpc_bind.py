#!/usr/bin/env python3
# Copyright (c) 2014-2019 The Sugarchain Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test running sugarchaind with the -rpcbind and -rpcallowip options."""
...
class RPCBindTest(SugarchainTestFramework):
    ...
    def run_allowip_test(self, allow_ips, rpchost, rpcport):
        ...
        node_args = (
            ...
            + [
                "-rpcbind=" + addr
                for addr in ["127.0.0.1", "%s:%d" % (rpchost, rpcport)]
            ]
