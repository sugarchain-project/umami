...
class EstimateFeeTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(
            -1, "estimatesmartfee", self.nodes[0].estimatesmartfee
        )
        assert_raises_rpc_error(
            -1, "estimaterawfee", self.nodes[0].estimaterawfee
        )
        ...
        assert_raises_rpc_error(
            -1, "estimaterawfee", self.nodes[0].estimaterawfee, 1, 1, 1
        )
