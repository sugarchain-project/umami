...
class ImportMultiTest(SugarchainTestFramework):
    ...
    def test_importmulti(
        self, req, success, error_code=None, error_message=None, warnings=None
    ):
    ...
    def run_test(self):
        ...
        timestamp = self.nodes[1].getblock(self.nodes[1].getbestblockhash())[
            "mediantime"
        ]
        ...
        # Sugarchain Address (implicit non-internal)
        self.log.info("Should import an address")
        key = get_key(self.nodes[0])
        self.test_importmulti(
            {"scriptPubKey": {"address": key.p2pkh_addr}, "timestamp": "now"},
            success=True,
        )
        test_address(
            self.nodes[1],
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": "not valid address"},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
        ...
        key = get_key(self.nodes[0])
        self.test_importmulti(
            {"scriptPubKey": nonstandardScriptPubKey, "timestamp": "now"},
            success=False,
            error_code=-8,
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": watchonly_address},
                "timestamp": "now",
            },
            success=True,
        )
        ...
        key = get_key(self.nodes[0])
        self.test_importmulti(
            {"scriptPubKey": {"address": key.p2wpkh_addr}, "timestamp": "now"},
            success=True,
        )
        test_address(
            self.nodes[1], key.p2wpkh_addr, iswatchonly=True, solvable=False
        )
        ...
        test_address(
            self.nodes[1], key.p2wpkh_addr, ismine=False, solvable=True
        )
        ...
        test_address(
            self.nodes[1], key.p2wpkh_addr, iswatchonly=False, ismine=True
        )
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": multisig.p2wsh_addr},
                "timestamp": "now",
            },
            success=True,
        )
        ...
        test_address(
            self.nodes[1], key.p2sh_p2wpkh_addr, solvable=False, ismine=False
        )
        ...
        test_address(
            self.nodes[1], key.p2sh_p2wpkh_addr, solvable=True, ismine=False
        )
        ...
        test_address(
            self.nodes[1], key.p2sh_p2wpkh_addr, solvable=True, ismine=True
        )
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": multisig.p2sh_p2wsh_addr},
                "timestamp": "now",
        ...
        test_address(
            self.nodes[1], multisig.p2sh_p2wsh_addr, solvable=True, ismine=False
        )
        ...
        self.test_importmulti(
            {"desc": descsum_create(desc), "timestamp": "now"}, success=True
        )
        test_address(self.nodes[1], address, solvable=True, ismine=True)
        ...
        test_address(
            self.nodes[1], key1.p2pkh_addr, ismine=False, iswatchonly=False
        )
        ...
        result = self.nodes[0].importmulti(
            [
                {
                    "desc": descsum_create(
                        "wpkh([" + pub_fpr + pub_keypath[1:] + "]" + pub + ")"
                    ),
                    "timestamp": "now",
                }
            ]
        ...
        self.nodes[1].createwallet(
            wallet_name="noprivkeys", disable_private_keys=True
        )
        ...
        self.nodes[1].createwallet(
            wallet_name="w1", blank=True, passphrase="pass"
        )
