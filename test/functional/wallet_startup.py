...
Verify that a sugarchaind node can maintain list of wallets loading on startup
"""
...
class WalletStartupTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(
            set(self.nodes[0].listwallets()), set(("", "w1", "w2", "w3", "w4"))
        )
        self.restart_node(0)
