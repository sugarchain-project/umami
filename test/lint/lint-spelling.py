...
def main():
    ...
    codespell_args = [
        ...
        "--disable-colors",
        "--quiet-level=7",
        "--ignore-words={}".format(IGNORE_WORDS_FILE),
    ] + files
    ...
    try:
        ...
        print(
            "^ Warning: codespell identified likely spelling errors. Any false positives? Add them to the list of ignored words in {}".format(
                IGNORE_WORDS_FILE
            )
        )
