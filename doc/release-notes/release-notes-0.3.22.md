Download URL: https://sourceforge.net/projects/sugarchain/files/Sugarchain/sugarchain-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SUGAR fee schedule (users still pay 0.01 SUGAR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #sugarchain00 - #sugarchain99
