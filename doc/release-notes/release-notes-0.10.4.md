Sugarchain Core version 0.10.4 is now available from:

  <https://sugarchain.org/bin/sugarchain-core-0.10.4/>
...
- #6953 `43c2789` Split sugarchain-tx into its own package
- #6953 `dfe0d4d` Include sugarchain-tx binary on Debian/Ubuntu
