Sugarchain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sugarchain/files/Sugarchain/sugarchain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sugarchain
...
New/changed settings (command-line or sugarchain.conf file)
--------------------------------------------------------
