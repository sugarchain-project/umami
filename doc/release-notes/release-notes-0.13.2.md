Sugarchain Core version 0.13.2 is now available from:

  <https://sugarchain.org/bin/sugarchain-core-0.13.2/>
...
- #8908 `4a974b2` Update sugarchain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow sugarchain-tx to create v2 transactions (sugardrak)
