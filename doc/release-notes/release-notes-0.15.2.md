Sugarchain Core version *0.15.2* is now available from:

  <https://sugarchaincore.org/bin/sugarchain-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in sugarchain-tx (TheBlueMatt)
