Sugarchain Core version 0.16.3 is now available from:

  <https://sugarchaincore.org/bin/sugarchain-core-0.16.3/>
...
been discovered in Sugarchain Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` sugarchainconsensus: invalid flags error should be set to `sugarchainconsensus_err` (afk11)
