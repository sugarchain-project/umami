Sugarchain Core version 0.9.4 is now available from:

  https://sugarchain.org/bin/0.9.4/
...
this update is incompatible with the Sugarchain system and could lead to consensus
forks.

Sugarchain Core released binaries from https://sugarchain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sugarchain/+archive/ubuntu/sugarchain
- A third-party or self-compiled Sugarchain Core

upgrade to Sugarchain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
