Sugarchain Core version 0.9.2.1 is now available from:

  https://sugarchain.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SUGAR to 0.01 SUGAR
...
- Fix "Start sugarchain on system login"
