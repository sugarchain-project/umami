...
Sugarchain Core version 0.19.1 is now available from:

  <https://sugarchaincore.org/bin/sugarchain-core-0.19.1/>
...
From Sugarchain Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Sugarchain Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Sugarchain Core does not yet change appearance when
...
- #17488 fix "sugarchaind already running" warnings on macOS (fanquake)
