Sugarchain Core version *0.15.0.1* is now available from:

  <https://sugarchain.org/bin/sugarchain-core-0.15.0.1/>

and

  <https://sugarchaincore.org/bin/sugarchain-core-0.15.0.1/>
