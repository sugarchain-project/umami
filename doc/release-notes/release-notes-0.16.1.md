Sugarchain Core version 0.16.1 is now available from:

  <https://sugarchaincore.org/bin/sugarchain-core-0.16.1/>
...
- #12843 `df38b13` Test starting sugarchaind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure sugarchaind processes are cleaned up when tests end (sdaftuar)
