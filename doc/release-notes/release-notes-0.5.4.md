Sugarchain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sugarchain/files/Sugarchain/sugarchain-0.5.4/
...
http://gitorious.org/sugarchain/sugarchaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sugarchain-Qt notifications under Growl 1.3.
Increase required age of Sugarchain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSugarchain properly when installing Sugarchain-Qt over it. (Windows)
