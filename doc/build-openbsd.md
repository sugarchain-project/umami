...
This guide describes how to build sugarchaind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/sugarchain/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/sugarchain/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Sugarchain Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
