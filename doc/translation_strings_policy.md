...
This document provides guidelines for internationalization of the Sugarchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sugarchain_en.ts` remains unchanged.
