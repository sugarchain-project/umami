...
Assumeutxo is a feature that allows fast bootstrapping of a validating sugarchaind
...
considered active. This is the "traditional" mode of operation for sugarchaind.
...
### Sugarchaind restarts sometime after snapshot validation has completed
