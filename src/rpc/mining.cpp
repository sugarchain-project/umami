...
// NOTE: Unlike wallet RPC (which use SUGAR values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/sugarchain/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/sugarchain/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/sugarchain/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/sugarchain/bips/blob/master/bip-0145.mediawiki\n",
        {
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.sugarchain.it/wiki/BIP_0022 for full specification.\n",
        {
