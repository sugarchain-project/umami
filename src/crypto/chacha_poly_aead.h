...
/* A AEAD class for ChaCha20-Poly1305@sugarchain.
 *
 ...
 *
 * The chacha20-poly1305@sugarchain combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@sugarchain cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@sugarchain are relatively fast in
