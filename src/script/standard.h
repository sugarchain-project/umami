 ...
 *  A CTxDestination is the internal data type encoded in a sugarchain address
 */
...
/**
 * Generate a Sugarchain scriptPubKey for the given CTxDestination. Returns a P2PKH
