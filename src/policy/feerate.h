...
const std::string CURRENCY_UNIT = "SUGAR"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    SUGAR_KVB,      //!< Use SUGAR/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SUGAR_KVB) const;
