...
public:
    ...
    explicit SugarchainGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SugarchainGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, SugarchainUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(SugarchainUnit newUnits);
