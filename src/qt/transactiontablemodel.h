...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SugarchainUnits::SeparatorStyle separators=SugarchainUnits::SeparatorStyle::STANDARD) const;
