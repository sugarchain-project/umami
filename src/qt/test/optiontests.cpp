...
{
    // Test regression https://github.com/sugarchain/sugarchain/issues/24457. Ensure
...
void OptionTests::parametersInteraction()
{
    ...
    // It was fixed via https://github.com/sugarchain-core/gui/pull/568.
    // With fListen=false in ~/.config/Sugarchain/Sugarchain-Qt.conf and all else left as default,
    // sugarchain-qt should set both -listen and -listenonion to false and start successfully.
