...
//! Entry point for SugarchainApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SugarchainApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SugarchainGUI tests.
void AppTests::guiTests(SugarchainGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SugarchainGUI::consoleShown, this, &AppTests::consoleTests);
