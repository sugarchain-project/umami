...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/sugarchain/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sugarchain/sugarchain>";
