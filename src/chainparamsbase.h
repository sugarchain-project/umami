// Copyright (c) 2014-2020 The Sugarchain Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between sugarchain-cli and sugarchaind)
 * of a given instance of the Sugarchain system.
 */
